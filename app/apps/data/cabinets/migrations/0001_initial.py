    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('election', models.ForeignKey(blank=True, help_text='previous election — value is added or updated on save',
                 null=True, on_delete=django.db.models.deletion.CASCADE, to='elections.election')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('defector', models.BooleanField(default=False,
                ...
                ('cabinet', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='cabinets.cabinet')),
        ...
        migrations.AddConstraint(
            model_name='cabinet',
            constraint=models.CheckConstraint(condition=models.Q(('start_date__lte', models.F(
                'termination_date'))), name='cabinet_start_date_smaller_than_termination_date'),
        ),
    ]
